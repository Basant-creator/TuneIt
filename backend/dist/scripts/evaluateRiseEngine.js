...
exports.runRiseEngineEvaluation = runRiseEngineEvaluation;
...
function renderAsciiTrajectoryMap(sequenced) {
    ...
    return sequenced
        ...
        let stepTag = '[STEP_UP]  ';
        if (track.stepType === 'DIP')
            stepTag = '⚡[DIP! -0.04]';
        else if (track.stepType === 'PLATEAU')
            stepTag = '[PLATEAU]  ';
        else if (track.stepType === 'PUSH_PEAK')
            stepTag = '🔥[PUSH/PEAK]';
...
function runRiseEngineEvaluation() {
    console.log('\n========================================================================================');
    ...
    const jamendoPath = path_1.default.join(__dirname, 'fixtures', 'mtg_jamendo_dataset.json');
    ...
    const output = (0, riseAlgorithm_1.processRiseAlgorithm)(rawData);
    ...
    const windowPass = (0, riseAlgorithm_1.checkEveryWindowHasDip)(sequencedTracks, 6);
